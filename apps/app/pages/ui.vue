  ...
  <div class="flex flex-col gap-10">
    ...
    <UiCard title="Champs de formulaire">
      <div class="flex flex-col gap-4">
        ...
        />
        <UiInput v-model="sampleEmail" label="Email" type="email" error="Adresse email invalide." />
    ...
    <UiCard title="Icônes (lucide)">
      <p class="mb-4 text-sm text-ink-500">
        Toujours via <code class="text-xs">@lucide/vue</code>, stroke-width 1.75–2. Jamais d'émojis
        ni de SVG inline ad hoc.
      </p>
    ...
    <UiCard title="Skeleton (chargement)">
      <p class="mb-4 text-sm text-ink-500">
        Plusieurs petits skeletons qui épousent la forme du contenu final, plutôt qu'un grand bloc.
      </p>
